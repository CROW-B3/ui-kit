 ...
 * @param {'positive' | 'negative' | 'warning' | 'neutral' | 'info' | 'high' | 'medium' | 'low'} [props.variant] - Semantic variant
 * @param {'default' | 'sm'} [props.size] - Badge size
 * @param {string} [props.className] - Additional CSS classes
 * @param {boolean} [props.uppercase] - Whether to uppercase the text
 * @param {boolean} [props.tracking] - Whether to add letter spacing
